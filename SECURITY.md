...
- The GitHub Pages domain must be listed in Firebase Console → Authentication → Settings → Authorized domains.

### Code Security
- No `any` types in TypeScript — use proper typing.
- Validate and sanitize all user inputs.
- Use `console.error` only for genuine errors — avoid logging sensitive data.
