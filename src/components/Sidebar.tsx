...
const SideBarCard: React.FC<SideBarCardProps> = ({
  ...
  return (
    <div
      ...
      `}
    >
      <div className="text-base md:text-lg font-medium text-slate-900 dark:text-white">{name}</div>
    </div>
  );
};
...
const Sidebar: React.FC<SidebarProps> = ({ selectedCollectionName, setSelectedCollectionName }) => {
  return (
    <div className="flex flex-col gap-2 md:gap-3 overflow-y-auto h-full">
      <SideBarCard
        name="Carousel Items"
